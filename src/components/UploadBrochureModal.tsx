  ...
  return (
    ...
    >
      <form
        ...
        className="shadow-modal animate-pop-in w-full max-w-md rounded-2xl bg-[var(--paper)] p-6"
      >
        <div className="mb-5 flex items-start justify-between gap-3">
          ...
          <button
            ...
            disabled={isBusy}
            aria-label="Close"
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-[var(--ink)]/60 transition hover:bg-[var(--paper-2)] hover:text-[var(--ink)] disabled:opacity-40"
          >
        ...
        <input
          ...
          disabled={isBusy}
          className="font-sans-ui mb-5 w-full rounded-lg border border-[var(--line)] bg-white px-4 py-3 text-sm text-[var(--ink)] outline-none transition-shadow focus:border-[var(--ink)]/30 focus:shadow-[0_0_0_3px_rgba(255,173,33,0.18)] disabled:opacity-60"
        />
        ...
        <button
          type="submit"
          disabled={isBusy}
          className="shadow-btn font-sans-ui w-full rounded-full bg-[var(--ink)] px-5 py-3 text-sm font-medium text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-[var(--accent)] hover:text-[var(--ink)] active:translate-y-0 disabled:translate-y-0 disabled:opacity-60"
        >
